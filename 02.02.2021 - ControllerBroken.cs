...
namespace MController_2
{
    ...
    public class ControllerBroken : MonoBehaviour, INonSkippableVideoAdListener, IInterstitialAdListener
    {
        ...
        [SerializeField] public Text WayText_Broken;
        ...
        [SerializeField] public GameObject WayImgMono;
        ...
        void Update()
        {
            if (_controller.isGrounded)
            {
                ...
                {
                    gravity = Vector3.zero;
                    _animator.SetTrigger("JumpBroken");
                    _canJumping = false;
                    gravity.y = JumpForce;
            ...
            WayText_Broken.text = TotalDistance.ToString("0");
            ...
            if (Input.GetKeyDown(KeyCode.Escape) && !IsPaused)
            {
                ...
                WayImg.SetActive(false); CardiiImg.SetActive(false); PauseBtn.SetActive(false); JumpBtn.SetActive(false); CrouchBtn.SetActive(false); FpsImg.SetActive(false); WayImgClassic.SetActive(false); WayImgMono.SetActive(false); 
            }
        ...
        public IEnumerator DoRoll()
        {
            if (TotalDistance <= 2500)
            {
                print("IsRolling");
                _canCrouch = true;
                _animator.SetBool("CrouchBroken", true);
                ...
                print("Not rolling");
                _canCrouch = false;
                _animator.SetBool("CrouchBroken", false);
        ...
        {
            _animator.ResetTrigger("JumpBroken");
        }
        ...
        public void OnClickGame()
        {
            ...
            WayImg.SetActive(true); CardiiImg.SetActive(true); PauseBtn.SetActive(true); WayImgClassic.SetActive(false); WayImgMono.SetActive(false);
...
;
        ...
        public void ContinueGame()
        {
            ...
            else if (CardiiInt >= 150)
            {
                ...
                _animator.SetBool("DeadBroken", false);
                _animator.SetBool("CrouchBroken", false);
        ...
        private void OnTriggerStay(Collider other)
        {
            if (other.tag == "Dead")
            {
                ...
                if (HP <= 0)
                {
                    ...
                    _animator.SetBool("DeadBroken", true);
                    _animator.SetBool("CrouchBroken", false);
            ...
            if (other.tag == "Dead_under")
            {
                ...
                if (HP <= 0)
                {
                    ...
                    CrouchBtn.SetActive(false);
                    FpsImg.SetActive(false);
                    WayImgMono.SetActive(false); WayImgClassic.SetActive(false);
