...
namespace MController
{
    ...
    public class MainController : MonoBehaviour, INonSkippableVideoAdListener, IInterstitialAdListener
    {
        ...
        [SerializeField] public Text WayText;
        ...
        void Update()
        {
            ...
            WayText.text = TotalDistance.ToString("0");
            ...
            if (Input.GetKeyDown(KeyCode.Escape) && !IsPaused)
            {
                ...
                WayImgBroken.SetActive(false); WayImgMono.SetActive(false);
        ...
        public void OnClickGame()
        {
            ...
            WayImg.SetActive(true); CardiiImg.SetActive(true); PauseBtn.SetActive(true); WayImgBroken.SetActive(false); WayImgMono.SetActive(false);
        ...
        public void OnClickPause()
        {
            ...
            WayImg.SetActive(false); CardiiImg.SetActive(false); PauseBtn.SetActive(false); JumpBtn.SetActive(false); CrouchBtn.SetActive(false); FpsImg.SetActive(false); WayImgBroken.SetActive(false); WayImgMono.SetActive(false);
        }
        ...
        private void OnTriggerStay(Collider other)
        {
            ...
            if (other.tag == "Dead_under")
            {
                ...
                if (HP <= 0)
                {
                    ...
                    CrouchBtn.SetActive(false);
                    FpsImg.SetActive(false);
                    WayImgMono.SetActive(false); WayImgBroken.SetActive(false);
